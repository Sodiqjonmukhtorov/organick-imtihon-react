...
const Footer = () => {
  return (
    <footer>
      <span className="mt-[176px] justify-end relative z-10 flex items-center place-content-center  ">
        <img
        ...
        <label className="absolute flex ">
          <input
            type="text"
            className=" w-[389px] pr-40 h-[80px] rounded-[16px] border-0 bg-white-50 px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear "
        ...
        <div className="flex justify-center text-end lg:py-10 lg1300:flex flex-wrap">
          ...
          <div className="max-w-[700px]  text-center p-0 border-x-2 ">
            ...
            <p className=" p-4 pt-20 text-center text-gray-500 blue-80 font-normal text-2xl">
              Najot Ta'lim N62 group Sodiqjon Mukhtorov DEVELOPMENT
            </p>
